...
<div class="container-fluid">
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">                      
                            ...
                            <p class="mb-0 text-truncate text-muted">Dành cho sinh viên</p>                
                        </div><!--end col-->
                    </div>  <!--end row-->                                  
                </div><!--end card-header-->
                <div class="card-body">
                    <div class="text-center">
                        <div id="task_status">
                            ...
                            <br>
                            <span>Sinh viên scan mã này để tham gia dự án</span>
                            <br>
                            <span>Hoặc nhập thông tin dưới đây vào nút tham gia dự án</span>
                            <br>
                            <hr>
                            ...
                            <tbody>
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" onclick="deleteUser('{{$user->fullname}}', {{$user->user_id}}, {{$user->countTasks}})" class="btn btn-sm btn-danger">Xoá</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    <div class="modal fade" id="CreateTask" tabindex="-1" aria-labelledby="CreateTaskLabel" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen-sm-down">
            <div class="modal-content" id="CreateTaskPulse">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <small class="text-muted">Bạn đánh giá task này đạt bao nhiêu điểm trong thang 0-5?
                                    <br>Hướng dẫn:
                                    <br>- Điểm 0: Không đạt
                                    <br>- Từ 1-5: Đạt
                                </small>
...
@section('scripts')
    ...
    <script>
        const createTask = () => {
            ...
            if(start && deadline && user_id && priority && name){
                Notiflix.Block.pulse('#CreateTaskPulse');
                $.ajax({
                    type: "POST",
                    url: "{{url('api/teacher/create-task')}}",
                    data: {
                    ...
                    Notiflix.Block.remove('#CreateTaskPulse');
                    if(res.success == true){
    ...
    <script>
            ...
            if(user_id && project_id){
                Notiflix.Confirm.show(
                    ...
                    function okCb(){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{url('api/teacher/delete-user')}}",
                            data: {
                                user_id: user_id,
                                project_id: project_id,
                            },
            ...
            if(task_id && project_id){
                Notiflix.Confirm.show(
                    ...
                    function okCb(){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{url('api/teacher/task-delete')}}",
                            data: {
                                task_id: task_id,
                                project_id: project_id,
                            },
            ...
            if(task_id && project_id){
                Notiflix.Confirm.show(
                    ...
                    function okCb(){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{url('api/teacher/task-update')}}",
                            data: {
                                task_id: task_id,
        ...
        //sử dụng ajax post
        $.ajax({
            url: '{{url("api/teacher/file-attack")}}', 
            dataType: 'JSON',
            cache: false,
            contentType: false,
            processData: false,
